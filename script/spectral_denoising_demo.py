...
def main():
    ...
    print(f'the denoised spectral has similarity of {entropy_similarity(denoised_spectrum, reference_spectrum, pmz = query_pmz):.2f}')
    ...
    print(f'the frist denoised spectra has similarity of {entropy_similarity(denoised_spectra[0], reference_spectrum, pmz = pmz):.2f}')
